...
- **[Technical notes](03_technical_notes.md)** — for maintainers: architecture, data flow, and known weak spots (internal document — useful if you're extending the pipeline, not required reading to just use LabBank).
